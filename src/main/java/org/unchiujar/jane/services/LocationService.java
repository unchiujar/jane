...
package org.unchiujar.jane.services;

import java.util.ArrayList;

import org.unchiujar.jane.R;
import org.unchiujar.jane.activities.WaypointMap;
import org.unchiujar.jane.location.LocationOrder;
...
public class LocationService extends Service {
    ...
    public static final String MOVEMENT_UPDATE = "org.unchiujar.jane.MOVEMENT_UPDATE";

    public static final String LATITUDE = "org.unchiujar.jane.LocationService.LATITUDE";

    public static final String LONGITUDE = "org.unchiujar.jane.LocationService.LONGITUDE";
    public static final String ACCURACY = "org.unchiujar.jane.LocationService.ACCURACY";
    ...
    private void displayRunningNotification() {
        ...
        Intent notificationIntent = new Intent(this, WaypointMap.class);
